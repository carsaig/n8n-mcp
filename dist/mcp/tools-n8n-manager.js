    ...
    },
    {
        ...
        inputSchema: {
            ...
            properties: {
                ...
                includeUsage: { type: 'boolean', description: 'For list/get: also return workflows that reference each credential (id, name, active). On list, triggers a full scan of ALL credential pages (ignores cursor/limit, no nextCursor returned). Slower on large instances. Default: false.' },
                ...
                limit: { type: 'number', description: 'For list: max results per page. Ignored when includeUsage is true.' },
            },
            required: ['action'],
        },
        annotations: {
