...
2.  **Registry Upload:** `docker push ghcr.io/carsaig/n8n-mcp:v2.30.2-cs.8s.7s.6s.5s.4s.2s.1s.3s.2`
...
- **Container Version**: `ghcr.io/carsaig/n8n-mcp:v2.30.2-cs.8s.7s.6s.5s.4s.2s.1s.3s.2`
