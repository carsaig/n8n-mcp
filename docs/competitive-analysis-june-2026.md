...
3. **Telemetry context.** The usage-pattern figures in §3.3 are carried forward from the 2026-04-30 telemetry pull and are explicitly dated; they were **not** re-queried for this edition. They are used only to establish that iteration dominates usage — not to project a counterfactual dollar figure against the official server (see §3.3 for why that projection was retired).
