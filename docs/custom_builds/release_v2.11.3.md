...
```
docker pull ghcr.io/carsaig/n8n-mcp:v2.30.2-cs.11s.10s.9s.8s.7s.6s.5s.4s.2s.1s.3s.2
```

## 🔗 Container Registry

*   **GitHub Container Registry**: `ghcr.io/carsaig/n8n-mcp:v2.30.2-cs.11s.10s.9s.8s.7s.6s.5s.4s.2s.1s.3s.2`
...
1.  **Replace container image**: `ghcr.io/carsaig/n8n-mcp:v2.30.2-cs.11s.10s.9s.8s.7s.6s.5s.4s.2s.1s.3s.2`
