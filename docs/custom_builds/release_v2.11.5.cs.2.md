...
- Dual tags pushed:
  - `ghcr.io/carsaig/n8n-mcp:v2.30.2-cs.7s.6s.5s.4s.2s.1s.2`
  - `ghcr.io/carsaig/n8n-mcp:v2.30.2-cs.7s.6s.5s.4s.2s.1st`
...
### Docker
```
docker pull ghcr.io/carsaig/n8n-mcp:v2.30.2-cs.7s.6s.5s.4s.2s.1s.2
```

## 🔗 Container Registry
- GHCR: `ghcr.io/carsaig/n8n-mcp:v2.30.2-cs.7s.6s.5s.4s.2s.1s.2`
